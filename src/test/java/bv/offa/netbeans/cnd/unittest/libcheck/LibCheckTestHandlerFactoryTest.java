...
@Tag("Test-Framework")
@Tag("LibCheck")
public class LibCheckTestHandlerFactoryTest
{
    ...
    public void setUp()
    {
        factory = new LibCheckTestHandlerFactory();
    }
    ...
    {
        factory.createHandlers();
        assertEquals(TestFramework.LibCheck.getName(), Manager.getInstance().getTestingFramework());
    }
    ...
    public void allHandlersForFramework()
    {
        ...
        {
            assertEquals(TestFramework.LibCheck, ((CndTestHandler) h).getTestFramework());
        });
    }
}
